...
#QUESTÃO - Método de discriminação de estímulos auditivos para primatas através do condicionamento operante.
'''
...
informe = input('Digite a Recompensa que será entregue ao %s' %(nome))
print('%s, Aguarde...' %(informe))

print('Tudo Ok para iniciar-mos')
